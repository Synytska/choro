...
export const selectChildGender = (state: RootState) =>
  state.onboarding.childGender;
export const selectChildCode = (state: RootState) => state.onboarding.childCode;
export const selectOnboardingTasks = (state: RootState) =>
  state.onboarding.tasks;
...
export const selectPrizeCoinAmount = (state: RootState) =>
  state.onboarding.prize.coinAmount;
export const selectPrizeImageUri = (state: RootState) =>
  state.onboarding.prize.imageUri;
